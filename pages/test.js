...
export default () => {
  const handleSign = async () => {
    ...
    const txParams = {
      ...
      value: '0x0',
      data: '',
      gasLimit: '0x2e1f3',
      gasPrice,
      nonce: 183,
    };
    ...
    const transactionHash = web3.utils.toHex(
      keccakFromHexString(rawTransaction),
    );
